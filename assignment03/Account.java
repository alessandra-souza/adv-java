...
class Account {
	...
	public void withdraw(double amount) {
		balance -= amount;
		Transaction widthdrawTransaction = new Transaction(new Date(), 'W', balance, "You executed a widthdraw");
		transactions.add(widthdrawTransaction);
	}
	
	public void deposit(double amount) {
		balance += amount;
		Transaction depositTransaction = new Transaction(new Date(), 'D', balance, "You executed a deposit");
